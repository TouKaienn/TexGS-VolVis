...
def inpaint_viewpoint(sd_cfg, cnet, save_result_dir, render_image, render_mask, render_depth, inpaint_view_ids=[(1)]):
    # projection
    print(f"Project inpaint view {inpaint_view_ids}...")
    inpaint_used_key = ["image", "depth", "uncolored_mask"]

    one_batch_img = [render_image, render_depth, render_mask]

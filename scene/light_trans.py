...
class LearningLightTransform:
    ...
    def __init__(self, theta=0, phi=0, useHeadLight=True, specular_multi=1.0, light_intensity_multi=1.0, ambient_multi=1.0, shininess_multi=1.0):
        self.theta = theta
        self.phi = phi
        self.specular_multi = specular_multi
        self.specular_offset = 0
        self.light_intensity_multi = light_intensity_multi
        self.light_intensity_offset = 0
        self.ambient_multi = ambient_multi
        self.ambient_offset = 0
        self.shininess_multi = shininess_multi

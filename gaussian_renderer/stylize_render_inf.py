...
def stylize_render_inf(iteration, viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, \
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, is_training=False, transform_dict=None):
    ...
    texture_channels = 3 # R,G,B, RGB^2 (for color sparsity loss)
    ...
    def custom_texture_gaussians(custom_rgbs, custom_texture, custom_opacities, texture_information, custom_settings):
